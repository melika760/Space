...
const Home = () => {
  return (
    <div className="xl:bg-[url('./assets/home/background-home-desktop.jpg')] md:bg-[url('./assets/home/background-home-tablet.jpg')] bg-cover bg-center h-screen overflow-hidden">
      <Nav/>
      <div className='xl:flex xl:justify-between  xl:h-[632px] xl:w-[1110px] md:w-[768px] md:h-[928px]  md:flex md:flex-col md:justify-evenly m-auto items-center max-lg:text-center'>
