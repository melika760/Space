...
const Home = () => {
  return (
  <section className="xl:bg-[url('./assets/home/background-home-desktop.jpg')] md:bg-[url('./assets/home/background-home-tablet.jpg') bg-[url('./assets/home/background-home-mobile.jpg')]  xl:h-[130vh] md:h-[130vh] bg-cover bg-center xl:bg-repeat-y ">
    <Nav/>
