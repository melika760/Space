...
const Home = () => {
  return (
  <section className="xl:bg-[url('./assets/home/background-home-desktop.jpg')] md:bg-[url('./assets/home/background-home-tablet.jpg') bg-[url('./assets/home/background-home-mobile.jpg')]  h-[130vh] bg-cover bg-center bg-repeat   ">
    <Nav/>
      <div className='xl:flex xl:justify-between h-[632px]  xl:h-[632px] xl:w-[1110px]  md:h-[928px]  md:flex max-lg:flex-col  md:mt-[15rem]  mt-12  justify-between  xl:mt-0 text-center  m-auto items-center w-[323px]'>
