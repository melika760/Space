...
const Home = () => {
  ...
  <section className="xl:bg-[url('./assets/home/background-home-desktop.jpg')] md:bg-[url('./assets/home/background-home-tablet.jpg') bg-[url('./assets/home/background-home-mobile.jpg')]  h-[130vh] bg-cover bg-center bg-repeat-y  ">
    <Nav height={"h-[130vh]"}/>
      <div className='flex xl:justify-between h-[632px]  max-xs:h-[632px] xl:w-[1110px]  max-md:h-[928px]  md:flex max-lg:flex-col  md:mt-[15rem]   mt-[12rem] justify-between  xl:mt-0 text-center  m-auto items-center w-[323px]'>
