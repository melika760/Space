...
const Home = () => {
  ...
  <PageLayout bgClass={"xl:bg-[url('./assets/home/background-home-desktop.jpg')] md:bg-[url('./assets/home/background-home-tablet.jpg')]  overflow-hidden"}>
      <div className='xl:flex xl:justify-between  xl:h-[632px] xl:w-[1110px]  md:h-[928px]  md:flex max-lg:flex-col md:justify-between md:mt-[8rem] md:items-center m-auto items-center max-lg:text-center'>
