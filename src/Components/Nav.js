...
const Nav = () => {
 ...
 <header className='pt-10 flex justify-center'>
   ...
   <nav className='bg-white bg-opacity-10 h-[96px] xl:w-[906px] md:w-[640px]'>
<ul className='text-white flex justify-center items-center h-full xl:space-x-36  md:justify-evenly'>
